...
export const PianosMenuItem = () => (
  <NavigationMenuItem>
    ...
    <NavigationMenuContent>
      <ul className="grid w-[500px] gap-3 p-4 md:grid-cols-2 group-hover/services:opacity-30 transition-opacity duration-200">
...
export const ServicesMenuItem = () => (
  <NavigationMenuItem className="group/services">
    ...
    <NavigationMenuContent>
      <ul className="grid w-[500px] gap-3 p-4 group-hover/pianos:opacity-30 transition-opacity duration-200">
